...
var FC = function() {
  ...
  self.applyCSS = function(customTheme, style_group, css_version) {
    ...
    if (style_group !== undefined) {
      ...
      style.setAttribute('href', '//s.4cdn.orgcss/catalog_'
...
ThreadWatcher.parseCatalog/jsON = function(data) {
  var catalog;
...
ThreadWatcher.fetchCatalog = function(board, catalogs, meta) {
  ...
  xhr.onload = function() {
    meta.count--;
    catalogs[board] = ThreadWatcher.parseCatalog/jsON(this.responseText);
    if (!meta.count) {
...
ThreadWatcher.parseThread/jsON = function(data) {
  var thread;
...
ThreadWatcher.fetch = function(key, img) {
  ...
  xhr.onload = function() {
    ...
    if (this.status == 200) {
      posts = ThreadWatcher.parseThread/jsON(this.responseText);
